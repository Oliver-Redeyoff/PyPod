...
try:
    ...
    font18 = ImageFont.truetype("./Assets/Font00.ttf",18) 
    ...
    Font1 = ImageFont.truetype("./Assets/Font01.ttf",16)
    Font2 = ImageFont.truetype("./Assets/Font01.ttf",20)
    Font3 = ImageFont.truetype("./Assets/Font02.ttf",25)
    ...
    image = Image.open('./Assets/LCD_1inch8.jpg')	
    im_r=image.rotate(0)
    disp.ShowImage(im_r)
    time.sleep(3)
